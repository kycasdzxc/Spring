...
public class UploadController {
	private static final String UPLOAD_FOLDER = "C:/upload_ex02";
	...
	public void uploadForm(@ModelAttribute MultipartFile[] uploadFile) {
		...
		for(MultipartFile multipartFile : uploadFile) {
			...
			try {
				multipartFile.transferTo(new File("c:/upload_ex02", multipartFile.getOriginalFilename()));
	...
	public List<AttachFileDTO> upload(MultipartFile[] files) throws IllegalStateException, IOException {
		...
		File uploadPath = new File("c:/upload_ex02", getFolder());
